...
public sealed record CartaoCreditoResponse(Guid Id, string Nome, string Banco, string Bandeira, decimal Limite, decimal LimiteUtilizado, int DiaFechamento, int DiaVencimento, string? Cor, bool Ativo);
...
public sealed record CompraCartaoResponse(Guid Id, string Descricao, decimal ValorTotal, decimal ValorParcela, DateOnly DataCompra, int NumeroParcelaAtual, int QuantidadeParcelas, Guid CartaoCreditoId);
